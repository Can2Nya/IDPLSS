...
from app.models import User, Role, Follow, Post, PostComment, Course, CourseComment, VideoList,  TextResource, \
    ...
    TextResourceBehavior, CourseChapter, CourseNode, CourseResource, CourseNodeBehavior
...
def make_shell_context():
    return dict(app=app, db=db, User=User, Role=Role, Follow=Follow, Post=Post, PostComment=PostComment,
                ...
                TextResourceBehavior=TextResourceBehavior, redis_store=redis_store, CourseResource=CourseResource,
                CourseChapter=CourseChapter, CourseNode=CourseNode, CourseNodeBehavior=CourseNodeBehavior)
